...
public class BinarySearchTree {
	...
	private BinarySearchTreeNode insert(BinarySearchTreeNode currentNode, Integer value) {
		if(currentNode == null) {
			return newNode(value);
		}else if (value <=currentNode.getData()) {
			BinarySearchTreeNode newNode = insert(currentNode.getLeftNode(),value);
			currentNode.setLeftNode(newNode);
			return currentNode;
		}else {
			BinarySearchTreeNode newNode = insert(currentNode.getRightNode(),value);
